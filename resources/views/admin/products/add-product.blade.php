		...
		<div class="box-body">
          ...
          <div class="form-group">
              ...
              <label>SKU </label>
                <div class="row">
				          <div class="col-xs-6">
                  <input name="sku" type="text"  class="form-control" placeholder="enter sku" required>
                  </div>
				        </div>
                  @if ($errors->has('sku'))
									<span class="help-block">
			...
			<div class="form-group">
              ...
              <label>Model </label>
                <div class="row">
				          <div class="col-xs-6">
                  <input name="model" type="text"  class="form-control" placeholder="enter model" required>
                  </div>
				        </div>
                  @if ($errors->has('model'))
									<span class="help-block">
			...
			<div class="form-group">
				<div class="form-group{{ $errors->has('points') ? ' has-error' : '' }}">
				  <label>Points </label>
					<div class="row">
						<div class="col-xs-6">
							<input name="points" type="text"  class="form-control" placeholder="enter points" required>
						</div>
					</div>
